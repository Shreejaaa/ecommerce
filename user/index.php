...
<section class="favourite__section">
    <div class="container-lg">
        ...
        <div class=" product-slider">
             <a href="guestbutcher.php" class="product">
                 <img src="images/butcher.jpg" alt="Product">
                 <div class="name">BUTCHERS </div>
             </a>

             <a href="guestgreengrocer.php" class="product">
             ...
             <a href="guestfishmonger.php" class="product">
             ...
             <a href="guestbakery.php" class="product">
             ...
             <a href="guestdelicatessen.php" class="product">
