...
if (isset($_POST["submit"])) {
    ...
    $plainPassword = $_POST["password"]; // Plain text password from the form
    ...
    $passwordValidationResult = validatePassword($plainPassword);
    if ($passwordValidationResult !== true) {
        echo "<script>alert('$passwordValidationResult'); window.location.href = 'sign_in_up.php';</script>";
        exit;
    }
    ...
    if (empty($role) || empty($firstname) || empty($lastname) || empty($age) || empty($contact) || empty($email) || empty($username) || empty($password)) {
        echo "<script>alert('All fields must be filled.'); window.location.href = 'sign_in_up.php';</script>";
        exit;
    }
...
if (isset($_POST["verify_otp"])) {
    ...
    if ($user_otp == $_SESSION['v_code']) {
        ...
        echo "<script>alert('OTP verified successfully.'); window.location.href = 'sign_in_up.php';</script>";
    } else {
...
<body>
    <div class="container">
        ...
        <div class="signup-container">
            ...
            <form class="form-signup" method="POST" action="sign_in_up.php">
                <div class="role-selection">
                    ...
                    <label class="role-option trader">
                        <input type="radio" name="role" value="Trader" required>
    ...
    <div class="otp-popup" id="otp-popup">
        <span class="close-icon" onclick="hideOtpPopup()">X</span>
        <h2>Enter OTP</h2>
    ...
    <script>
        ...
        document.querySelectorAll('.role-option input[type="radio"]').forEach(input => {
